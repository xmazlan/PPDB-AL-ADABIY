...
class Panel_admin extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->session->userdata('id_admin') == NULL) {
			...
			redirect('panel_admin/log_in'); // jika user belum login otomatis mengarahkan ke halaman login
		} else {
			$data = array(
	...
	public function log_in()
	{
		...
		if ($sess != NULL) {
			// $this->load->view('404_content');
			redirect('panel_admin'); // jika user sudah login otomatis mengarahkan ke halaman admin
		} else {
