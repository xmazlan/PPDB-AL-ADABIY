  ...
  <div class="panel-body">
      ...
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Hobi <span class="text-danger">*</span></label>
        <div class="col-sm-9" style="margin-top:3px;">
          <select class="form-control bg-blue class" data-placeholder="Pilih Hobi Siswa" name="hobi" data-parsley-group="block1" data-parsley-errors-container='div[id="error-hobi"]' required>
              <option value="">Pilih hobi siswa</option>
    ...
    <div class="form-group">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Pernah PAUD <span class="text-danger">*</span></label>
        ...
        <div id="error-paud" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
      </div>
    </div>
    ...
    <div class="form-group">
      <label class="col-sm-3 control-label" style="text-align:right; margin-top:6px">Pernah TK <span class="text-danger">*</span></label>
        ...
        <div id="error-tk" style=" background:#FFBABA;color: #D8000C; width:auto;border-radius:5px;padding-left:10px;"></div>
      </div>
    </div> -->
