...
<head>
  ...
  <link rel="icon" href="assets/images/smaja3.png" type="image/x-icon" />
          ...
          <ul class="header-menu nav navbar-nav">
            ...
            <li class="dropdown" id="language-header">
              <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                <span style="color:#ddd;">PPDB Tahun Pelajaran <b class="text-danger" style="color:#fff;"><?php echo date('Y'); ?>-<?php echo date('Y') + 1; ?></b></span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div>
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> <?php echo $user['nama_lengkap']; ?></strong></h2>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 panel p-20" style="text-align:center">
                                ...
                                <span style="font-size:15px">
                                  Proses PPDB Online <?php echo $user['nama_lengkap']; ?> hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                  <br><br>
                                  <div class="col-md-12">
            ...
            <div class="footer">
              <div class="copyright">
                <p class="pull-left sm-pull-reset">
                  <span>Copyright &copy; <a href="https://www.mr-ell.com" target="_blank"><?php echo $user['nama_lengkap']; ?></a> <?php echo date('Y'); ?></span>
                </p>
