...
<body onload="window.print();">
  ...
  <table width="100%" border="0" style="margin-left:5px;">
    ...
    <tr>
      <td>4.</td>
      <td>Surat Keterangan Lulus <b>(*Apabila sudah ada)</b></td>
      <td>:</td>
      <td>1 lembar</td>
    </tr>
    <tr>
    ...
    <tr>
      <td valign="top">6.</td>
      <td colspan="3">Semua berkas dimasukan kedalam map dan diserahkan kepada Panitia PPDB <?php echo $id['nama_lengkap']; ?> Tahun Pelajaran <?php echo $id['th_pelajaran']; ?></td>
    </tr>
  </table>
