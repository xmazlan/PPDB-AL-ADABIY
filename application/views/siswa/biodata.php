    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="panel panel-flat">
          <div class="panel-body">
            <fieldset class="content-group">
              <legend class="text-bold"><i class="icon-profile"></i> File</legend>
              <div class="table-responsive">
                <table class="table table-bordered table-striped">
                  <tr>
                    <th width="30%">KK</th>
                    <th width="1%">:</th>
                    <td><a href="<?= base_url('uploads/' . $user->kk) ?>" target="_blank">KK</a></td>
                  </tr>
                  <tr>
                    <th width="30%">KTP</th>
                    <th width="1%">:</th>
                    <td><a href="<?= base_url('uploads/' . $user->ktp) ?>" target="_blank">KTP</a></td>
                  </tr>
                </table>
              </div>
            </fieldset>
